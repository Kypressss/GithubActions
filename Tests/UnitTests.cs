...
namespace GithubActionsLab
{
    ...
    public class Math
    {
        ...
        {
            Assert.Throws<FormatException>(() => Program.Power("1", ")"));
            Assert.Throws<FormatException>(() => Program.Power(")", "1"));
        ...
        {
            Assert.AreEqual(null, Program.Power("1", null));
            Assert.AreEqual(null, Program.Power(null, "1"));
            Assert.AreEqual(null, Program.Power(null, null));
        }
